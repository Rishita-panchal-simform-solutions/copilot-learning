...
/// Usage:
/// ```
/// @UserDefault(key: UDSettings.Device.deviceToken.key,
/// defaultValue: UDSettings.Device.deviceToken.defaultValue)
...
struct UserDefaultCodable<Value: Codable> {
    ...
    static func getValue(forKey key: String, in storage: UserDefaults = .standard) -> Value? {
